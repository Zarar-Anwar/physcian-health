                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="doctor-details-desc">
                            <h2>Hello i’m Dr. Omar Ahmed MD Introducing My Self.</h2>
        ...
        <section class="doctor-details-area ptb-100">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-12">
                        <div class="doctor-details-desc">
                            <h2>Hello i’m Dr. Steve Ideyi MD Introducing My Self.</h2>
        ...
        <section class="doctor-details-area ptb-100">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="doctor-details-desc">
                            <h2>Hello i’m Dr. Tyrone johnson MD Introducing My Self.</h2>
        ...
        <section class="doctor-details-area ptb-100">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-12">
                        <div class="doctor-details-desc">
                            <h2>Hello i’m Dr. Tonge Introducing My Self.</h2>
        ...
        <section class="doctor-details-area ptb-100">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="doctor-details-desc">
                            <h2>Hello i’m Dr. Karey Nesbeth NP Introducing My Self.</h2>
        ...
        <section class="doctor-details-area ptb-100">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-12">
                        <div class="doctor-details-desc">
                            <h2>Hello i’m Dr. Vincent NZE NP Introducing My Self.</h2>
